...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<spring:url value="/resources/styles/dropdown.css"/>"/>
</head>
                ...
                <li>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="<spring:url value="/banhub/gamma/player"/>">Поиск по игроку</a>
                            <a href="<spring:url value="/banhub/gamma/admin"/>">Поиск по администратору</a>
                        </div>
                    </div>
                </li>
                    <%--<a href="<c:url value="/banhub/player" />" class="lang" key="bans">Баны</a></li>--%>
                <li><a href="<spring:url value="/crew" />" class="lang" key="monitor">Состав</a></li>
